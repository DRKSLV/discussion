...
function Dialog(props) {
  ...
  function keyDwn(evt) {
    ...
    if (lineRef.current && lineRef.current.keyDwn() !== true) return;
...
var Line = Object(react__WEBPACK_IMPORTED_MODULE_0__["forwardRef"])(function eLine(_ref, ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useImperativeHandle"])(ref, function () {
    return {
      keyDwn: function keyDwn() {
        ...
        if (current.options) {
          if (!current.stayInOptions && option !== -1) {
            var answers = current.options[option].answer;
  ...
  }, [current, option, line, innerLine, lineRef]);
...
//# sourceMappingURL=dialog.js.080258bac075b08588ab.hot-update.js.map