...
function usePosts(ids) {
  ...
  var _useRef = useRef(),
      _useRef2 = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_0__["default"])(_useRef, 2),
      prev = _useRef2[0],
      setPrev = _useRef2[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (id.active === prev && prev.current.ids === ids) return;
    prev.current = {
      ac: id.active,
      ids: ids
    };
...
//# sourceMappingURL=index.js.59ad05609805da04501b.hot-update.js.map