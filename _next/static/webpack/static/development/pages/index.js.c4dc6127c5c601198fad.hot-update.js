...
function usePosts(ids) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    console.log("ids", ids);
    console.log("ACTIVE_> ", id.active, prev.ac);
    console.log(JSON.stringify(prev.ids));
    console.log(JSON.stringify(ids));

    if (id.active === prev.ac && JSON.stringify(prev.ids) === JSON.stringify(ids)) {
      console.log("DENIED");
      return;
    }
...
//# sourceMappingURL=index.js.c4dc6127c5c601198fad.hot-update.js.map