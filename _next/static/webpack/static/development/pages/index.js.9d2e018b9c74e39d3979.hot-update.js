...
/* harmony import */ var _babel_runtime_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @babel/runtime/helpers/esm/readOnlyError */ "./node_modules/@babel/runtime/helpers/esm/readOnlyError.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_10___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_10__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _constants_index__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../constants/index */ "./constants/index.js");
...
var Identity = Object(react__WEBPACK_IMPORTED_MODULE_10__["createContext"])([{
  active: null,
  users: []
}, undefined]);
var initActive = null;
var IdentityProvider = /*#__PURE__*/function (_React$Component) {
  ...
  function IdentityProvider(props) {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_8__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "addUser", function (idString, username, accessToken) {
      _this.setState(function (prev) {
        ...
        if (index === -1) newO.users = [].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(newO.users), [{
          idString: idString,
          username: username,
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(IdentityProvider, [{
    ...
    value: function check(idx) {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_11___default.a.get("/user/me", {
        headers: {
          Authorization: "Bearer ".concat(this.state.id.users[idx].accessToken)
        },
        baseURL: _constants_index__WEBPACK_IMPORTED_MODULE_12__["apiUrl"]
      }).then(function (val) {
    ...
    value: function checkActive() {
      ...
      if (this.state.id.active !== null) {
        ...
        this.state.axios.get("/user/me").then(function (val) {
          console.log("✔ Account ok: ", val);
          ...
          _this3.setState(function (prev) {
            ...
            e[newO.active].username = val.data.username;
            e[newO.active].moderator = val.data.moderator;
            delete e[newO.active].error;
            newO.users = e;
            return {
              id: newO
            };
    ...
    value: function beforeMount() {
      ...
      var instance = axios__WEBPACK_IMPORTED_MODULE_11___default.a.create({
        baseURL: _constants_index__WEBPACK_IMPORTED_MODULE_12__["apiUrl"]
      });
      ...
      initActive = (Object(_babel_runtime_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_9__["default"])("initActive"), active); //this.setState(prev=> {return {id: {active, users, addUser: this.addUser, removeUser: this.removeUser, setActive: this.setActive}, axios: instance}});
    }
  }, {
    key: "componentDidMount",
    value: function componentDidMount() {
      publish();
      this.setActive(initActive);
    }
  }, {
    key: "render",
...
var useIdentity = function useIdentity() {
  return Object(react__WEBPACK_IMPORTED_MODULE_10__["useContext"])(Identity);
};
...
//# sourceMappingURL=index.js.9d2e018b9c74e39d3979.hot-update.js.map