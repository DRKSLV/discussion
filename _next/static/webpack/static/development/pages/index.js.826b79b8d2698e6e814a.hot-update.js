...
function usePosts(ids) {
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])(id.active),
      prev = _useState3[0],
      setPrev = _useState3[1];

  console.log(ids);
  console.log("ACTIVE_> ", id.active);
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    if (id.active === prev) return;
  ...
  }, [ids, id, axios]); //console.log(configChange);
...
//# sourceMappingURL=index.js.826b79b8d2698e6e814a.hot-update.js.map