  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useImperativeHandle"])(ref, function () {
    return {
      keyDwn: function keyDwn() {
        ...
        if (current.options) {
          if (!current.stayInOptions && option !== -1 && option >= (current.options[option].answer.length - 1 || 0)) return true;
          console.log(current);
          setLine(function (prev) {
            if (option === -1) return prev;
            return prev + 1;
...
//# sourceMappingURL=dialog.js.594dcf8e448aab34a611.hot-update.js.map