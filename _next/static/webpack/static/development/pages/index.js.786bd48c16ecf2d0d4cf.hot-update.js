...
function PostList(props) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function (eee) {
    console.log("scroll");
    console.log(props.rerender); //console.log(JSON.stringify(refs));

    if (refs[props.rerender]) {
      console.log("scrolling");
      refs[props.rerender].scrollIntoView();
    }
...
//# sourceMappingURL=index.js.786bd48c16ecf2d0d4cf.hot-update.js.map