...
function PostForm(props) {
  ...
  function submit(evt) {
    ...
    if (title.length >= 1 && title.length <= 150) {
      axios.post("/post/", {
        title: title,
        text: text
      }).then(function (response) {//close drawer
        //show post 
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null, __jsx("form", {
    ...
    className: _style_postForm_module_sass__WEBPACK_IMPORTED_MODULE_3___default.a.titleCounter,
...
//# sourceMappingURL=index.js.8b114354f84cf6a0ebad.hot-update.js.map