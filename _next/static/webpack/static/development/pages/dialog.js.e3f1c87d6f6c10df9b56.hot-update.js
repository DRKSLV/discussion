  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useImperativeHandle"])(ref, function () {
    return {
      keyDwn: function keyDwn() {
        ...
        if (current.options) {
          if (!current.stayInOptions && option !== -1 && option >= (current.options[option].answer.length - 1 || 0)) console.log(current);
          setLine(function (prev) {
            if (option === -1) return prev;
            return prev + 1;
          });
...
//# sourceMappingURL=dialog.js.e3f1c87d6f6c10df9b56.hot-update.js.map