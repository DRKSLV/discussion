          ...
          if (reason.response && reason.response.headers["www-authenticate"]) {
            ...
            switch (error.err) {
              ...
              case "TokenClaimError":
                if (error.desc === "insufficient claims.") error.icon = "bolt";else if (error.desc === "invalid claims.") error.icon = "death";
            ...
            return _this2.setState(function (prev) {
              ...
              newUsers[prev.active] = _objectSpread({}, newUsers[prev.active], {
                error: error
              });
              console.log(_objectSpread({}, newUsers[prev.active], {
                error: error
              }));
              return {
...
//# sourceMappingURL=index.js.d39f35b4fb7602d66bfd.hot-update.js.map