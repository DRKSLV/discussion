...
var Post = react__WEBPACK_IMPORTED_MODULE_2___default.a.forwardRef(function (props, ref) {
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            axios.put("/entity/".concat(p.entity.id), {
              ...
              if (res.data.comments_hidden) {
                setComState("hidden");
              } else if (res.data.comments_locked) {
                setComState("locked");
              } else {
                setComState("e");
              }
  ...
  }, !p.entity.comments_hidden ? __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, p.entity.comments_locked ? "LOCKED -" : "", " ", (p.entity.comment.rgt - p.entity.comment.lft - 1) / 2) : __jsx("b", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 211,
...
//# sourceMappingURL=index.js.c90fe3ab7066ea05444f.hot-update.js.map